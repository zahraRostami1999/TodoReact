...
const InputTasks = () => {
    ...
    return (
        <div className="w-full flex justify-center flex-wrap p-1">
            <div className="flex items-center w-full lg:max-w-3xl xl:max-w-3xl md:max-w-3xl sm:max-w-2xl bg-white rounded-full shadow-lg overflow-hidden 
                ...
                <input
                    type="text"
                    className="flex-grow px-6 py-1 text-xl text-right lg:text-3xl font-medium text-gray-700 placeholder-gray-400
