    ...
    return (
        <>
            <header className='w-full'>
                <div className="font-sans font-semibold flex justify-center flex-w sm:w-full md:w-11/12 lg:w-full">
                    <div className="w-full sm:text-center xs:text-center md:text-left lg:text-left ">
                        <div className="flex items-center justify-between">
                            ...
                            <h1 className="text-4xl hover:scale-95 cursor-pointer transition-all duration-300" onClick={logout}>
                                <IoIosLogOut size={28} className="hover:text-red-500 transition-all duration-300" />
                            </h1>
                        </div>
                    </div>
                </div>
